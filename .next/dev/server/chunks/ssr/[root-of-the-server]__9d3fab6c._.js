...
(()=>{
    const e = new Error("Cannot find module '@/app/configs/endpoints.config'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
class Product extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] {
    ...
    getTopPicks = async ()=>{
        return this.instance({
            method: ApiRoutes.products.topPicks.Method,
            url: ApiRoutes.products.topPicks.Endpoint
        });
    };
    //  Product Details
    getProductDetails = async (id)=>{
        return this.instance({
            method: ApiRoutes.products.details.Method,
            url: `${ApiRoutes.products.details.Endpoint}/${id}`
        });
    };
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d3fab6c._.js.map